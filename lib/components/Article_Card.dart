...
class _ArticleCardState extends State<ArticleCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(bottom: 30, top: 20, left: 20, right: 20),
      width: 500,
      height: 320,
      decoration: BoxDecoration(boxShadow: const [
        BoxShadow(color: Color(0xffe8e8e8), blurRadius: 5.0)
      ], color: ArticleColor, borderRadius: BorderRadius.circular(20)),
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(
                  top: 16, left: 20, right: 14, bottom: 10),
              child: Row(
